...
BASE_SILVER = f"s3://{S3_BUCKET_NAME}/silver/"
BASE_GOLD   = f"s3://{S3_BUCKET_NAME}/gold/"
...
try:
  # Leitura das tabelas fato da camada SILVER.
  ...
  # Para cada tabela GOLD, realiza a verificação de qualidade conforme os checks definidos
  # e as escreve em path_output.
